...
<?php if (isset($_SESSION["login"])) { ?>
    <?php if ($_SESSION['login']['level'] == 'Penumpang') { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <?php if ($login['level'] == 'Admin') : ?>
                                    <a href="../kapal/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <?php if ($login['level'] == 'Admin') : ?>
                                    <a href="../nahkoda/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                ...
                                <?php if ($login['level'] == 'Admin') : ?>
                                    <a href="../destinasi/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <!-- ./col -->
