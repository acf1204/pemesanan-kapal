                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-1">
                                                            <input type="hidden" name="id_kapal" class="form-control" id="recipient-name" value="<?= $kapal['id_kapal'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Nama Kapal:</label>
                                                            <input type="text" name="nama_kapal" class="form-control" id="recipient-name" value="<?= $kapal['nama_kapal'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Kat:</label>
                                                            <input type="text" name="kat" class="form-control" id="recipient-name" value="<?= $kapal['kat'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Jenis:</label>
                                                            <input type="text" name="jenis" class="form-control" id="recipient-name" value="<?= $kapal['jenis'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Harga:</label>
                                                            <input type="number" name="harga" class="form-control" id="recipient-name" value="<?= $kapal['harga'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Nahkoda:</label>
                                                            <input type="text" name="nama_nahkoda" class="form-control" id="recipient-name" value=<?= $kapal['nama_nahkoda'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Tanda Selar:</label>
                                                            <input type="text" name="tanda_selar" class="form-control" id="recipient-name" value="<?= $kapal['tanda_selar'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label for="recipient-name" class="col-form-label">Tempat Berangkat:</label>
                                                            <input type="text" name="tanda_selar" class="form-control" id="recipient-name" value="<?= $kapal['tempat_berangkat'] ?>" readonly>
                                                        </div>
                                                        <div class="mb-1">
