                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pemesanan as $pemesanan) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $pemesanan['nama_kapal'] ?></td>
                                                    <td>
                                                        <?php if ($pemesanan['ketersediaan'] == '-') : ?>
                                                            ...
                                                            <form action="" method="post" class="d-inline" enctype="multipart/form-data">
                                                                <input type="hidden" name="id_pemesanan" value="<?= $pemesanan['id_pemesanan'] ?>">
                                                                <input type="hidden" name="ketersediaan" value="Tidak Tersedia">
                                                                <button type="submit" name="submit2" class="btn btn-danger"><i class="fas fa-times"></i></button>
                                                            </form>
                                                        <?php endif; ?>
                                                        <?php if ($pemesanan['ketersediaan'] == 'Tersedia') : ?>
                                                            <button type="submit" name="ketersediaan" class="btn btn-primary"><i class="far fa-check-circle"></i> Tersedia</button>
                                                        <?php endif; ?>
                                                        <?php if ($pemesanan['ketersediaan'] == 'Tidak Tersedia') : ?>
                                                            <button type="submit" name="ketersediaan" class="btn btn-danger"><i class="fas fa-times"></i> Tidak Tersedia</button>
                                                        <?php endif; ?>
                                                    </td>
