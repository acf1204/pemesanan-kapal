            ...
            <?php if ($login['level'] == 'Admin') : ?>
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../destinasi/index.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Data Destinasi</p>
                    </a>
                  </li>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Data Destinasi Musi Tour</h3>
                </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($destinasi as $destinasi) : ?>
                        <tr>
                          <td><?= $i ?></td>
                          <td><?= $destinasi['tujuan_destinasi'] ?></td>
                          <td class="text-center">
                            <a href="update.php?id_destinasi=<?= $destinasi['id_destinasi']; ?>" class="btn btn-warning" style="color: white;"><i class="fas fa-edit"></i></a>
                            <a href="delete.php?id_destinasi=<?= $destinasi['id_destinasi']; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data ini?')"><i class="fas fa-trash-alt"></i></a>
                          </td>
                        </tr>
                      <?php $i++;
                      endforeach; ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Tambah Data Destinasi</h5>
          </div>
          <form action="" method="post">
            <div class="modal-body">
              <div class="mb-1">
                <input type="hidden" class="form-control" name="id_destinasi" id="recipient-name">
              </div>
              <div class="mb-1">
                <label for="recipient-name" class="col-form-label">Tujuan Destinasi:</label>
                <input type="text" class="form-control" name="tujuan_destinasi" id="recipient-name">
              </div>
            </div>
