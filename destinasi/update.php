...
$destinasi = query("SELECT * FROM destinasi WHERE id_destinasi = $id_destinasi")[0];
?>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-body">
                                            <div class="mb-1">
                                                <input type="hidden" class="form-control" name="id_destinasi" value="<?= $id_destinasi ?>" id="recipient-name">
                                            </div>
                                            <div class="mb-1">
                                                <label for="recipient-name" class="col-form-label">Tujuan Destinasi:</label>
                                                <input type="text" class="form-control" name="tujuan_destinasi" id="recipient-name" value="<?= $destinasi['tujuan_destinasi'] ?>" require>
                                            </div>
                                        </div>
